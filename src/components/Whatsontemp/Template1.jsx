...
const Template1 = ({ venue, event, weekCommencing }) => {
				...
				<div className="font py-8 flex flex-col">
					<div className="flex justify-between ">
						...
						<Image
							width={50}
							height={40}
							className="xl:w-[80px] xl:h-[70px]"
							src="/images/whatson.png"
							alt="Residents Img"
						/>
					</div>
					<div className="w-full mt-1">
						<p className="text-[16px] text-[#62F55F] font-[300]">
							{result[0]}&nbsp;
						</p>
						<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[55%]"></div>
						<p className="text-[16px] text-[#62F55F] font-bold">
							{event1.name === '' ? 'No evnt' : event1.name}
						</p>
					</div>
					<div className="flex justify-between">
						<p className="text-xs text-[#D9D9D9] font-[300]">
							@ {event1.location === '' ? '/~' : event1.location}
						</p>
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#62F55F]">
								{result[1]}
							</p>
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event2.name === '' ? 'No evnt' : event2.name}
							</p>
						</div>
					</div>
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-start">
							...
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event3.name === '' ? 'No evnt' : event3.name}
							</p>
						</div>
						<p className="text-xs text-[#D9D9D9] font-[300]">
							{' '}
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							...
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event4.name === '' ? 'No evnt' : event4.name}
							</p>
						</div>
					</div>
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-start">
							...
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event5.name === '' ? 'No evnt' : event5.name}
							</p>
						</div>
						<p className="text-xs text-[#D9D9D9] font-[300]">
					...
					<div className="flex justify-between">
						...
						<p className="text-xs text-[#D9D9D9] font-[300]">
							{' '}
							{event5.location === '' ? '/~' : event5.location}
						</p>
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#62F55F]">
								{result[5]}
							...
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event6.name === '' ? 'No evnt' : event6.name}
							</p>
						</div>
					</div>
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-start">
							...
							<div className="bg-gradient-to-r from-[#EBFF00E0]  to-[#62F55FD9]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#62F55F] font-bold">
								{event7.name === '' ? 'No evnt' : event7.name}
							</p>
							<p className="text-xs text-[#D9D9D9] font-[300]">
								@{event7.location === '' ? '/~' : event7.location}
							</p>
						</div>
						<p className="text-xs text-[#D9D9D9] font-[300]">
							@ {event6.location === '' ? '/~' : event6.location}
						</p>
					</div>
				</div>
