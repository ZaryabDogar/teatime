...
const Template2 = ({ venue,event,weekCommencing }) => {
			...
			<div className=" flex flex-col">
				<div className="font py-8 flex flex-col">
					...
					<div className="w-full mt-1">
						<p className="text-[16px] text-[#F34F9D] font-[300]">{result[0]}&nbsp;</p>
						<div className="bg-gradient-to-r from-[#E42982D9]  to-[#FF3D00E0]  p-[1px] rounded-2xl w-[55%]"></div>
						<p className="text-[16px] text-[#F34F9D] font-bold">{event1.name===''?"No evnt":event1.name}</p>
					</div>
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							...
							<p className="text-[16px] text-[#F34F9D] font-bold">{event2.name===''?"No evnt":event2.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#F34F9D]">{result[3]}</p>
							<div className="bg-gradient-to-r from-[#E42982D9]  to-[#FF3D00E0]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#F34F9D] font-bold">{event4.name===''?"No evnt":event4.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="flex flex-col items-start">
							<p className="font-[300] text-[16px] text-[#F34F9D]">{result[4]}</p>
							<div className="bg-gradient-to-r from-[#E42982D9]  to-[#FF3D00E0]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#F34F9D] font-bold">{event5.name===''?"No evnt":event5.name}</p>
						</div>
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#F34F9D]">{result[5]}</p>
							<div className="bg-gradient-to-r from-[#E42982D9]  to-[#FF3D00E0]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#F34F9D] font-bold">{event6.name===''?"No evnt":event6.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="flex flex-col items-start">
							<p className="font-[300] text-[16px] text-[#F34F9D]">{result[6]}</p>
							<div className="bg-gradient-to-r from-[#E42982D9]  to-[#FF3D00E0]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#F34F9D] font-bold">{event7.name===''?"No evnt":event7.name}</p>
