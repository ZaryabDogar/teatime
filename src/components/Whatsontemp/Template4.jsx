...
const Template4 = ({ venue,event,weekCommencing }) => {
			...
			<div className=" flex flex-col">
				<div className="font py-8 flex flex-col">
					<div className="flex justify-between ">
						<div className="w-fit ">
							<p className="text-2xl text-[#5FF5C8] font-bold mb-1">
								WHATS ON?
							</p>
					...
					<div className="w-full mt-1">
						<p className="text-[16px] text-[#5FF5C8] font-[300]">{result[0]}&nbsp;</p>
						<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[55%]"></div>
						<p className="text-[16px] text-[#5FF5C8] font-bold">{event1.name===''?"No evnt":event1.name}</p>
					</div>
					<div className="flex justify-between">
						<p className="text-xs text-[#D9D9D9] font-[300]">@ {event1.location===''?'/~':event1.location}</p>
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[1]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event2.name===''?"No evnt":event2.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="flex flex-col items-start">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[2]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event3.name===''?"No evnt":event3.name}</p>
						</div>
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[3]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event4.name===''?"No evnt":event4.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="flex flex-col items-start">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[4]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event5.name===''?"No evnt":event5.name}</p>
						</div>
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col items-end">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[5]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event6.name===''?"No evnt":event6.name}</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="flex flex-col items-start">
							<p className="font-[300] text-[16px] text-[#5FF5C8]">{result[6]}</p>
							<div className="bg-gradient-to-r from-[#5FF5C8]  to-[#5FF5C8]  p-[1px] rounded-2xl w-[120%]"></div>
							<p className="text-[16px] text-[#5FF5C8] font-bold">{event7.name===''?"No evnt":event7.name}</p>
